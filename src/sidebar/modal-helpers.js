...
(function () {
  ...
  function _showNoteModal(opts) {
    ...
    // footer 縮小 (2026-07-13 兄貴指示: モバイルDB画面footerが場所を取りすぎる) に伴い、
    // unofficial/copyright 表記を footer から撤去し NOTE 冒頭に集約。PC/モバイル共通表示
    const unofficialText = T_.footerUnofficial || 'Unofficial fan-made tool. Not affiliated with NetEase Inc. / Everstone Studio.';
