      ...
      <details class="wwm-setup-collapse">
        ...
        <div class="wwm-setup-collapse-body">
          ...
          <div class="wwm-setup-panel" data-panel="mobile" ${isMobile?'':'hidden'}>
            <ol class="wwm-setup-steps">
              <li>${(window.T && T.importMobStep1) || '下のコードをコピー:'}<br><div style="font-size:10px;color:#0f0;background:#000;padding:2px 6px;border-radius:2px;display:inline-block;margin-bottom:4px;">BM v108 / ${bmUrl.length}文字</div><br><textarea class="wwm-bm-code" id="wwmBmCode" readonly>${bmUrl}</textarea><br><button class="wwm-btn-secondary" id="wwmCopyBtn">${(window.T && T.importCopy) || 'コピー'}</button></li>
