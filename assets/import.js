...
const _STAT_LABELS_I18N = {
  ja: {
    ...
    stMysticDmg: '単体系奇術', stBurstMysticDmg: '単体爆発系奇術',
    stControlMysticDmg: '単体制御系奇術', areaMysticDmg: '範囲系奇術',
    areaDmgMysticDmg: '範囲攻撃系奇術', areaDebuffMysticDmg: '範囲状態異常系奇術',
    bleed: '九変の剣 流血',
    moBladeShield: '断魂の刀 シールド効果',
    panaceaFanHealing: '薬川の扇 重撃回復量',
    swordQ: '九変の剣 武術技', swordCharged: '九変の剣 溜め技', swordSpecial: '九変の剣 特殊技',
    namelessSwordQ: '無銘の剣 武術技', namelessSwordCharged: '無銘の剣 溜め技', namelessSwordSpecial: '無銘の剣 特殊技',
    spearQ: '蛇神の槍 武術技', spearCharged: '蛇神の槍 溜め技', spearSpecial: '蛇神の槍 特殊技',
    namelessSpearQ: '無銘の槍 武術技', namelessSpearCharged: '無銘の槍 溜め技', namelessSpearSpecial: '無銘の槍 特殊技',
    stormbreakerQ: '嵐雷の槍 武術技', stormbreakerCharged: '嵐雷の槍 溜め技', stormbreakerSpecial: '嵐雷の槍 特殊技',
    fanQ: '墨筆の扇 武術技', fanCharged: '墨筆の扇 溜め技', fanSpecial: '墨筆の扇 特殊技',
    panaceaFanQ: '薬川の扇 武術技', panaceaFanSpecial: '薬川の扇 特殊技',
    moBladeCharged: '断魂の刀 溜め技', moBladeSpecial: '断魂の刀 特殊技',
    phalanxbaneQ: '破陣の刀 武術技', phalanxbaneCharged: '破陣の刀 溜め技',
    snowpartingQ: '斬雪の刀 武術技', snowpartingCharged: '斬雪の刀 溜め技', snowpartingVariedCombo: '斬雪の刀 軽重撃派生',
    infernalTwinbladesQ: '獄炎の双剣 武術技', infernalTwinbladesSpecial: '獄炎の双剣 特殊技', infernalTwinbladesLight: '獄炎の双剣 軽撃',
    umbQ: '千紅の傘 武術技', umbCharged: '千紅の傘 溜め技', umbDrone: '千紅の傘 特殊技',
    soulshadeUmbQ: '誘魂の傘 武術技', soulshadeUmbCharged: '誘魂の傘 溜め技', soulshadeUmbSpecial: '誘魂の傘 特殊技',
    everspringUmbQ: '醉夢の傘 武術技', everspringUmbCharged: '醉夢の傘 溜め技', everspringUmbSpecial: '醉夢の傘 特殊技',
    mortalRopeDartQ: '浮塵の縄 武術技', mortalRopeDartCharged: '浮塵の縄 溜め技', mortalRopeDartRodent: '浮塵の縄 鼠',
    unfetteredRopeDartQ: '浮雲の縄 武術技', unfetteredRopeDartCharged: '浮雲の縄 溜め技', unfetteredRopeDartSpecial: '浮雲の縄 特殊技'
  },
  en: {
    ...
    moBladeShield: 'Thundercry MB Shield',
    ...
    moBladeCharged: 'Thundercry MB Ch', moBladeSpecial: 'Thundercry MB Sp',
    ...
    umbQ: 'Vernal UM Q', umbCharged: 'Vernal UM Ch', umbDrone: 'Vernal UM Drone',
    ...
    unfetteredRopeDartQ: 'Unfettered RD Q', unfetteredRopeDartCharged: 'Unfettered RD Ch', unfetteredRopeDartSpecial: 'Unfettered RD Sp'
  },
  ...
  //   種別 suffix = ゲーム内武術変音プレビュー実測で全面確定 (2026-06-08): 武学技/蓄力技/特殊技/强效轻击/鼠鼠/护盾增效/重击回复/群体异常类/轻重击派生 (旧 Q强化等から改訂)。残推定 = 奇術 4 細分 (suffix は OCR 照合に非影響 — _normName が剥がす)
  zh: {
    ...
    areaDmgMysticDmg: '群体伤害类奇术增伤', areaDebuffMysticDmg: '群体异常类奇术增伤',
    bleed: '积矩九剑 流血',
    moBladeShield: '嗟夫刀法 护盾增效',
    panaceaFanHealing: '明川药典 重击回复',
    swordQ: '积矩九剑 武学技', swordCharged: '积矩九剑 蓄力技', swordSpecial: '积矩九剑 特殊技',
    namelessSwordQ: '无名剑法 武学技', namelessSwordCharged: '无名剑法 蓄力技', namelessSwordSpecial: '无名剑法 特殊技',
    spearQ: '九曲惊神枪 武学技', spearCharged: '九曲惊神枪 蓄力技', spearSpecial: '九曲惊神枪 特殊技',
    namelessSpearQ: '无名枪法 武学技', namelessSpearCharged: '无名枪法 蓄力技', namelessSpearSpecial: '无名枪法 特殊技',
    stormbreakerQ: '八方风雷枪 武学技', stormbreakerCharged: '八方风雷枪 蓄力技', stormbreakerSpecial: '八方风雷枪 特殊技',
    fanQ: '青山执笔 武学技', fanCharged: '青山执笔 蓄力技', fanSpecial: '青山执笔 特殊技',
    panaceaFanQ: '明川药典 武学技', panaceaFanSpecial: '明川药典 特殊技',
    moBladeCharged: '嗟夫刀法 蓄力技', moBladeSpecial: '嗟夫刀法 特殊技',
    phalanxbaneQ: '十方破阵 武学技', phalanxbaneCharged: '十方破阵 蓄力技',
    snowpartingQ: '斩雪刀法 武学技', snowpartingCharged: '斩雪刀法 蓄力技', snowpartingVariedCombo: '斩雪刀法 轻重击派生',
    infernalTwinbladesQ: '泥犁三垢 武学技', infernalTwinbladesSpecial: '泥犁三垢 特殊技', infernalTwinbladesLight: '泥犁三垢 强效轻击',
    umbQ: '九重春色 武学技', umbCharged: '九重春色 蓄力技', umbDrone: '九重春色 特殊技',
    soulshadeUmbQ: '千香引魂蛊 武学技', soulshadeUmbCharged: '千香引魂蛊 蓄力技', soulshadeUmbSpecial: '千香引魂蛊 特殊技',
    everspringUmbQ: '醉梦游春 武学技', everspringUmbCharged: '醉梦游春 蓄力技', everspringUmbSpecial: '醉梦游春 特殊技',
    mortalRopeDartQ: '粟子游尘 武学技', mortalRopeDartCharged: '粟子游尘 蓄力技', mortalRopeDartRodent: '粟子游尘 鼠鼠',
    unfetteredRopeDartQ: '粟子行云 武学技', unfetteredRopeDartCharged: '粟子行云 蓄力技', unfetteredRopeDartSpecial: '粟子行云 特殊技'
  },
  // ko: 2026-06-07 ゲーム内実測で較正 — ステータス画面 7 枚 + 装備詳細 samples 32-36。
  //   縄 2 種 swap (mortal=속세의 지혜) / 기혈 최대치 / 武器種 = X 무술 피해 증가 (맥도=陌刀・쌍도=双刀、
  //   부채·우산 = 효과 증가) / 奇術 = 비결 (단일류/단체류)。武器名 9 個 + 種別 suffix = ゲーム内武術一覧+変音実測で全面改訂 (2026-06-08): 武器名 구현의 검무/격류의 파동/무명 검법/무명 창법/풍뢰의 징표/청산의 정수/천계의 수호/탄식의 검기/윤회의 가르침、suffix 무술/차지/특수 스킬・강력한 약 공격・쥐 기술・보호막 효과・중격 회복・이상류
  ko: {
    ...
    areaDmgMysticDmg: '단체 피해류 비결 피해 증가', areaDebuffMysticDmg: '단체 이상류 비결 피해 증가',
    bleed: '구현의 검무 출혈',
    moBladeShield: '탄식의 검기 보호막 효과',
    panaceaFanHealing: '천계의 수호 중격 회복',
    swordQ: '구현의 검무 무술 스킬', swordCharged: '구현의 검무 차지 스킬', swordSpecial: '구현의 검무 특수 스킬',
    namelessSwordQ: '무명 검법 무술 스킬', namelessSwordCharged: '무명 검법 차지 스킬', namelessSwordSpecial: '무명 검법 특수 스킬',
    spearQ: '격류의 파동 무술 스킬', spearCharged: '격류의 파동 차지 스킬', spearSpecial: '격류의 파동 특수 스킬',
    namelessSpearQ: '무명 창법 무술 스킬', namelessSpearCharged: '무명 창법 차지 스킬', namelessSpearSpecial: '무명 창법 특수 스킬',
    stormbreakerQ: '풍뢰의 징표 무술 스킬', stormbreakerCharged: '풍뢰의 징표 차지 스킬', stormbreakerSpecial: '풍뢰의 징표 특수 스킬',
    fanQ: '청산의 정수 무술 스킬', fanCharged: '청산의 정수 차지 스킬', fanSpecial: '청산의 정수 특수 스킬',
    panaceaFanQ: '천계의 수호 무술 스킬', panaceaFanSpecial: '천계의 수호 특수 스킬',
    moBladeCharged: '탄식의 검기 차지 스킬', moBladeSpecial: '탄식의 검기 특수 스킬',
    phalanxbaneQ: '십방파진 무술 스킬', phalanxbaneCharged: '십방파진 차지 스킬',
    snowpartingQ: '만설의 참격 무술 스킬', snowpartingCharged: '만설의 참격 차지 스킬', snowpartingVariedCombo: '만설의 참격 경중격 파생',
    infernalTwinbladesQ: '윤회의 가르침 무술 스킬', infernalTwinbladesSpecial: '윤회의 가르침 특수 스킬', infernalTwinbladesLight: '윤회의 가르침 강력한 약 공격',
    umbQ: '봄의 선율 무술 스킬', umbCharged: '봄의 선율 차지 스킬', umbDrone: '봄의 선율 특수 스킬',
    soulshadeUmbQ: '소생의 향 무술 스킬', soulshadeUmbCharged: '소생의 향 차지 스킬', soulshadeUmbSpecial: '소생의 향 특수 스킬',
    everspringUmbQ: '일장춘몽 무술 스킬', everspringUmbCharged: '일장춘몽 차지 스킬', everspringUmbSpecial: '일장춘몽 특수 스킬',
    ...
    mortalRopeDartQ: '속세의 지혜 무술 스킬', mortalRopeDartCharged: '속세의 지혜 차지 스킬', mortalRopeDartRodent: '속세의 지혜 쥐 기술',
    unfetteredRopeDartQ: '운진의 궤적 무술 스킬', unfetteredRopeDartCharged: '운진의 궤적 차지 스킬', unfetteredRopeDartSpecial: '운진의 궤적 특수 스킬'
  }
};
