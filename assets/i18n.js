...
const TRANSLATIONS = {
  ja: {
    ...
    toastSaved:'プリセット「{name}」を保存', toastLoaded:'プリセット「{name}」を読込', toastDeleted:'プリセット「{name}」を削除', toastExported:'画像を出力しました', toastImportWip:'工事中のため使用できません', scoreUpdateMsg:'計算データが更新されました。最新スコアを反映するには再インポートしてください', scoreUpdateBtn:'再インポート', migrationMsg:'新URLに移転しました: <strong>wwm-metrics.pages.dev</strong> — このURL (旧) は2026-06-08頃停止予定', migrationBtn:'新URLへ', importPrompt:'上部「IMPORT」ボタンからデータを取り込んでください', importHintLabel:'ここからインポート', importBtn:'IMPORT', exportBtn:'EXPORT', resetBtn:'RESET', shareBtn:'SHARE', noteBtn:'NOTE',
    ...
    optApplyAll:'全適用', optApplyOne:'適用', optApplySelected:'選択適用', optRecalc:'再計算', optTargetRatio:'目標', optSortLabel:'並び', optSortDefault:'改善順', optSortBySlot:'部位順', optNoImprovement:'改善余地なし', optSelectOne:'選択', optMinDeltaTip:'これ未満のΔで打切', optToggleAllTip:'全選択/全解除 切替',
...
finalScore  = statusScore + 4-set bonus (4点一式効果発動時)</pre>
  ...
  en: {
    ...
    toastSaved:'Saved "{name}"', toastLoaded:'Loaded "{name}"', toastDeleted:'Deleted "{name}"', toastExported:'Image exported', toastImportWip:'Under construction — not yet available', scoreUpdateMsg:'Calculation data updated. Re-import to reflect the latest scores.', scoreUpdateBtn:'Re-import', migrationMsg:'Moved to new URL: <strong>wwm-metrics.pages.dev</strong> — this old URL will be retired around 2026-06-08', migrationBtn:'Go to new URL', importPrompt:'Click the IMPORT button at the top to load data', importHintLabel:'Import here first', importBtn:'IMPORT', exportBtn:'EXPORT', resetBtn:'RESET', shareBtn:'SHARE', noteBtn:'NOTE',
    ...
    optApplyAll:'Apply All', optApplyOne:'Apply', optApplySelected:'Apply', optRecalc:'Recalc', optTargetRatio:'Target', optSortLabel:'Sort', optSortDefault:'Δ', optSortBySlot:'Slot', optNoImprovement:'No improvements available', optSelectOne:'Select', optMinDeltaTip:'Stop below this Δ', optToggleAllTip:'Toggle all on/off',
...
finalScore  = statusScore + 4-set bonus (when 4 Pieces active)</pre>
  ...
  zh: {
    ...
    toastSaved:'预设「{name}」已保存', toastLoaded:'预设「{name}」已读取', toastDeleted:'预设「{name}」已删除', toastExported:'图片已导出', toastImportWip:'施工中，暂不可用', scoreUpdateMsg:'计算数据已更新，请重新导入以反映最新分数。', scoreUpdateBtn:'重新导入', migrationMsg:'已迁移到新地址: <strong>wwm-metrics.pages.dev</strong> — 当前 (旧) 地址将于 2026-06-08 前后停用', migrationBtn:'前往新地址', importPrompt:'请点击上方「导入」按钮加载数据', importHintLabel:'从这里导入', importBtn:'导入', exportBtn:'导出', resetBtn:'重置', shareBtn:'分享', noteBtn:'笔记',
    ...
    optApplyAll:'全部应用', optApplyOne:'应用', optApplySelected:'应用所选', optRecalc:'重算', optTargetRatio:'目标', optSortLabel:'排序', optSortDefault:'按Δ', optSortBySlot:'按部位', optNoImprovement:'无改善余地', optSelectOne:'选择', optMinDeltaTip:'Δ低于此值时停止', optToggleAllTip:'切换全选/全清',
...
finalScore  = statusScore + 4-set bonus (四件套效果发动时)</pre>
  ...
  ko: {
    ...
    toastSaved:'프리셋 「{name}」 저장됨', toastLoaded:'프리셋 「{name}」 불러옴', toastDeleted:'프리셋 「{name}」 삭제됨', toastExported:'이미지 내보내기 완료', toastImportWip:'공사 중 — 아직 사용할 수 없습니다', scoreUpdateMsg:'계산 데이터가 업데이트되었습니다. 최신 점수를 반영하려면 다시 가져오세요.', scoreUpdateBtn:'다시 가져오기', migrationMsg:'새 URL로 이전했습니다: <strong>wwm-metrics.pages.dev</strong> — 현재 (구) URL 은 2026-06-08 경 종료 예정', migrationBtn:'새 URL로', importPrompt:'상단 「IMPORT」 버튼에서 데이터를 가져와 주세요', importHintLabel:'여기서 가져오기', importBtn:'가져오기', exportBtn:'내보내기', resetBtn:'초기화', shareBtn:'공유', noteBtn:'노트',
    ...
    optApplyAll:'전체 적용', optApplyOne:'적용', optApplySelected:'선택 적용', optRecalc:'재계산', optTargetRatio:'목표', optSortLabel:'정렬', optSortDefault:'Δ순', optSortBySlot:'부위순', optNoImprovement:'개선 여지 없음', optSelectOne:'선택', optMinDeltaTip:'이 Δ 미만 시 중단', optToggleAllTip:'전체 선택/해제 토글',
