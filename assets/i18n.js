...
const TRANSLATIONS = {
  ja: {
    ...
    optApplyAll:'全適用', optApplyOne:'適用', optApplySelected:'選択適用', optRecalc:'再計算', optTargetRatio:'目標',
...
finalScore  = statusScore + 4-set bonus (when 4 Pieces active)</pre>
  ...
  zh: {
    ...
    optApplyAll:'全部应用', optApplyOne:'应用', optApplySelected:'应用所选', optRecalc:'重算', optTargetRatio:'目标',
...
finalScore  = statusScore + 4-set bonus (四件套效果发动时)</pre>
  ...
  ko: {
    ...
    optApplyAll:'전체 적용', optApplyOne:'적용', optApplySelected:'선택 적용', optRecalc:'재계산', optTargetRatio:'목표',
