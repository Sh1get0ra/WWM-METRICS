...
const TRANSLATIONS = {
  ja: {
    ...
    optApplyAll:'全適用', optApplyOne:'適用', optApplySelected:'選択適用', optRecalc:'再計算', optTargetRatio:'目標', optSortLabel:'並び', optSortDefault:'改善順', optSortBySlot:'部位順', optNoImprovement:'改善余地なし',
...
finalScore  = statusScore + 4-set bonus (4点一式効果発動時)</pre>
  ...
  en: {
    ...
    optApplyAll:'Apply All', optApplyOne:'Apply', optApplySelected:'Apply', optRecalc:'Recalc', optTargetRatio:'Target', optSortLabel:'Sort', optSortDefault:'By Δ', optSortBySlot:'By Slot', optNoImprovement:'No improvements available',
...
finalScore  = statusScore + 4-set bonus (when 4 Pieces active)</pre>
  ...
  zh: {
    ...
    optApplyAll:'全部应用', optApplyOne:'应用', optApplySelected:'应用所选', optRecalc:'重算', optTargetRatio:'目标', optSortLabel:'排序', optSortDefault:'按Δ', optSortBySlot:'按部位', optNoImprovement:'无改善余地',
...
finalScore  = statusScore + 4-set bonus (四件套效果发动时)</pre>
  ...
  ko: {
    ...
    optApplyAll:'전체 적용', optApplyOne:'적용', optApplySelected:'선택 적용', optRecalc:'재계산', optTargetRatio:'목표', optSortLabel:'정렬', optSortDefault:'Δ순', optSortBySlot:'부위순', optNoImprovement:'개선 여지 없음',
