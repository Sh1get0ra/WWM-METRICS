...
const TRANSLATIONS = {
  ja: {
    ...
    toastSaved:'プリセット「{name}」を保存', toastLoaded:'プリセット「{name}」を読込', toastDeleted:'プリセット「{name}」を削除', toastExported:'画像を出力しました', toastImportWip:'工事中のため使用できません', importPrompt:'上部「IMPORT」ボタンからデータを取り込んでください', importBtn:'IMPORT',
  ...
  en: {
    ...
    toastSaved:'Saved "{name}"', toastLoaded:'Loaded "{name}"', toastDeleted:'Deleted "{name}"', toastExported:'Image exported', toastImportWip:'Under construction — not yet available', importPrompt:'Click the IMPORT button at the top to load data', importBtn:'IMPORT',
  ...
  zh: {
    ...
    toastSaved:'预设「{name}」已保存', toastLoaded:'预设「{name}」已读取', toastDeleted:'预设「{name}」已删除', toastExported:'图片已导出', toastImportWip:'施工中，暂不可用', importPrompt:'请点击上方「导入」按钮加载数据', importBtn:'导入',
  ...
  ko: {
    ...
    toastSaved:'프리셋 「{name}」 저장됨', toastLoaded:'프리셋 「{name}」 불러옴', toastDeleted:'프리셋 「{name}」 삭제됨', toastExported:'이미지 내보내기 완료', toastImportWip:'공사 중 — 아직 사용할 수 없습니다', importPrompt:'상단 「IMPORT」 버튼에서 데이터를 가져와 주세요', importBtn:'IMPORT',
